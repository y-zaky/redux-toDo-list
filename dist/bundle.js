...
var TODO_EDITED = exports.TODO_EDITED = "TODO_EDITED";
var EDIT_TODO = exports.EDIT_TODO = "EDIT_TODO";
var SAVETODO_EDIT = exports.SAVETODO_EDIT = "SAVETODO_EDIT";
var SAVE_TODO = exports.SAVE_TODO = "SAVE_TODO";
var TOGGLE_CLASS = exports.TOGGLE_CLASS = "TOGGLE_CLASS";
...
*/
var aa=__webpack_require__(3),l=__webpack_require__(13),B=__webpack_require__(4),C=__webpack_require__(1),ba=__webpack_require__(14),da=__webpack_require__(15),ea=__webpack_require__(16),fa=__webpack_require__(17),ia=__webpack_require__(18),D=__webpack_require__(6);
...
var _deleteToDo = __webpack_require__(78);

var _toDoEdited = __webpack_require__(79);

var _editToDo = __webpack_require__(80);

var _saveToDoEdit = __webpack_require__(81);

var _saveToDo = __webpack_require__(82);

var _toggleClass = __webpack_require__(83);
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.editToDoClicked = _this.editToDoClicked.bind(_this);
    _this.handleEditNewToDo = _this.handleEditNewToDo.bind(_this);
    _this.saveToDoEdit = _this.saveToDoEdit.bind(_this);
  ...
  _createClass(App, [{
    key: 'handleEditNewToDo',
    value: function handleEditNewToDo(e) {
    ...
    key: 'editToDoClicked',
    value: function editToDoClicked(index) {

      this.props.editToDoClicked(index);
    }
  }, {
    key: 'saveToDoEdit',
    value: function saveToDoEdit(e) {

      this.props.saveToDoEdit(e.target.value);
    }
  }, {
    key: 'saveToDo',
    value: function saveToDo(editedUserInput) {

      this.props.saveToDo(editedUserInput);
    }
  }, {
    key: 'toggleClass',
    value: function toggleClass(toDo) {
    ...
    value: function render() {
      ...
      var toDosListArr = this.props.toDo;

      var toDos = toDosListArr.map(function (toDo, index) {
        ...
        return _react2.default.createElement(_List2.default, {
          ...
          editClickedDispatch: _this2.editToDoClicked,
          saveToDoEdit: _this2.saveToDoEdit,
          editedSaveToDo: _this2.props.editedSaveToDo,
          saveToDo: _this2.saveToDo,
          value: _this2.props.toDo,
          'delete': _this2.deleteToDo,
          toggleClass: _this2.toggleClass,
          active: toDo.active
        });
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { id: 'main-todo-input', defaultValue: this.props.currentToDo, onChange: this.handleEditNewToDo }),
          _react2.default.createElement(
            'button',
            { className: 'button-addToDo', onClick: this.createTodo },
            'Add To Do'
          )
        ),
        _react2.default.createElement(
...
var mapDispatchToProps = {
  ...
  deleteToDo: _deleteToDo.deleteToDo,
  editToDoClicked: _toDoEdited.toDoEdited,
  editToDo: _editToDo.editToDo,
  saveToDoEdit: _saveToDoEdit.saveToDoEdit,
  saveToDo: _saveToDo.saveToDo,
  toggleClass: _toggleClass.toggleClass
};
...
var ListItem = function (_Component) {
  ...
  _createClass(ListItem, [{
    ...
    value: function render() {
      ...
      var toggleButton = this.props.active ? _react2.default.createElement(
        'button',
        { onClick: function onClick() {
            _this2.props.toggleClass({ index: _this2.props.index });
          } },
        'Unmark'
      ) : _react2.default.createElement(
        'button',
      ...
      var listItemEdit = this.props.editClicked ? _react2.default.createElement(
        'li',
        { className: 'list__li' },
        _react2.default.createElement('input', { defaultValue: this.props.toDo, onChange: this.props.saveToDoEdit }),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            'button',
            { onClick: function onClick() {
                _this2.props.editClickedDispatch(_this2.props.index);_this2.props.saveToDo({ toDo: _this2.props.editedSaveToDo, index: _this2.props.index });
              } },
            'Save'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick() {
                console.log('this', _this2);_this2.props.delete({ toDo: _this2.props.toDo, index: _this2.props.index });
              } },
            'Delete'
          )
        )
        ...
        'li',
        { className: this.props.active ? "list__li--active" : "list__li" },
        this.props.toDo,
        _react2.default.createElement(
          'div',
          { className: 'button__container' },
          _react2.default.createElement(
            'button',
            { onClick: function onClick() {
                return _this2.props.editClickedDispatch(_this2.props.index);
              } },
            'Edit'
          ),
          _react2.default.createElement(
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./style.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./style.css");
...
// imports
exports.push([module.i, "@import url(https://fonts.googleapis.com/css?family=Bungee+Inline|Open+Sans);", ""]);

// module
exports.push([module.i, "/* font-family: 'Open Sans', sans-serif;  -- matches well with bungeeInline*/\n* {\n  font-family: 'Bungee Inline', cursive;\n  font-size: 15px;\n}\nbody {\n  background-color: rgba(141, 141, 141, 0.637);\n  counter-reset: section;\n}\n.main-title {\n  color: white;\n  font-family: 'Bungee Inline', cursive;\n  font-size: 11vw;\n}\n.main__container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin-top: 100px;\n}\n.input-button-container {\n  display: flex;\n  align-items: center;\n}\n#main-todo-input {\n  width: 200px;\n  height: 35px;\n  outline-color: green;\n}\n.button-addToDo {\n  height: 35px;\n  padding: 5px;\n  font-size: 13px;\n}\n.toDo__item {\n  color: black;\n  font-size: 17px;\n  width: 400px;\n}\n.list__li--active {\n  text-decoration: line-through;\n  text-decoration-color: green;\n}\nli::before {\n  counter-increment: section;\n  /* Increment the value of section counter by 1 */\n  content: counter(section) \".\" \" \";\n}\nli {\n  display: flex;\n  margin-bottom: 3px;\n  align-items: center;\n}\nbutton {\n  border-radius: 10px;\n  padding: 5px;\n  background-color: #7B7476;\n  font-size: 13px;\n  margin-left: 2px;\n  outline-style: none;\n  cursor: pointer;\n}\n.button__container {\n  margin-left: 15px;\n  display: flex;\n}\ninput {\n  border-radius: 10px;\n  padding: 3px;\n  width: 100px;\n}\n/* Smartphones  */\n@media only screen and (min-width: 386px) {\n  input {\n    width: 150px;\n  }\n  #main-todo-input {\n    width: 250px;\n  }\n}\n@media only screen and (min-width: 425px) {\n  input {\n    width: 200px;\n  }\n  #main-todo-input {\n    width: 300px;\n  }\n}\n/* Mid size Smartphones*/\n@media only screen and (min-width: 586px) {\n  #main-todo-input {\n    width: 400px;\n  }\n  input {\n    width: 300px;\n  }\n}\n/* iPads/Tablets */\n@media only screen and (min-width: 768px) {\n  #main-todo-input {\n    width: 500px;\n  }\n  input {\n    width: 400px;\n  }\n}\n/* Desktops and laptops ----------- */\n@media only screen and (min-width: 857px) {\n  .main-title {\n    font-size: 100px;\n  }\n  li {\n    font-size: 16px;\n  }\n  button {\n    font-size: 14px;\n  }\n  .button-addToDo {\n    font-size: 16px;\n  }\n}\n", ""]);
...
exports.toDoEdited = undefined;

var _index = __webpack_require__(2);

var toDoEdited = exports.toDoEdited = function toDoEdited(index) {
  return {
    type: _index.TODO_EDITED,
    payload: index
  };
};
...
var editToDo = exports.editToDo = function editToDo(userInput) {
  return {
    type: _actionTypes.EDIT_TODO,
    payload: userInput
  };
};
...
exports.saveToDoEdit = undefined;

var _actionTypes = __webpack_require__(2);

var saveToDoEdit = exports.saveToDoEdit = function saveToDoEdit(editedUserInput) {
  return {
    type: _actionTypes.SAVETODO_EDIT,
...
exports.saveToDo = undefined;

var _actionTypes = __webpack_require__(2);

var saveToDo = exports.saveToDo = function saveToDo(editedUserInputObject) {
  return {
    type: _actionTypes.SAVE_TODO,
...
var toggleClass = exports.toggleClass = function toggleClass(toDoIndex) {
  return {
    type: _actionTypes.TOGGLE_CLASS,
    payload: toDoIndex
  };
};
...
exports.default = (0, _redux.createStore)(_reducers2.default, (0, _redux.compose)(middleware, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__()));
...
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; //how can i editToDo using a string and keeping it immutable?
...
exports.default = function () {
  ...
  switch (action.type) {
    ...
    case _index.EDIT_TODO:
      return _extends({}, state, {
        editToDo: action.payload
      });
    case _index.DELETE_TODO:
      return _extends({}, state, {
        toDo: state.toDo.filter(function (toDo, index) {
          return index !== action.payload.toDo.index;
        })
      });
    case _index.TODO_EDITED:
      return _extends({}, state, {
        toDo: state.toDo.map(function (toDo, index) {
          return toDo.index === action.payload ? _extends({}, toDo, { isEdited: !toDo.isEdited }) : toDo;
        })
      });
    case _index.SAVETODO_EDIT:
      return _extends({}, state, {
        saveToDoEdit: action.payload
      });
    case _index.SAVE_TODO:
      return _extends({}, state, {
        toDo: state.toDo.map(function (toDo, index) {
          return toDo.index === action.payload.index && !!action.payload.toDo ? _extends({}, toDo, { toDo: [action.payload.toDo] }) : toDo;
        })
      });
    case _index.TOGGLE_CLASS:
      return _extends({}, state, {
        toDo: state.toDo.map(function (toDo, index) {
          return toDo.index === action.payload.index ? _extends({}, toDo, { active: !toDo.active }) : toDo;
        })
      });
    default:
      return state;
